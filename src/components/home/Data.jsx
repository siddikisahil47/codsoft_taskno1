...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <p className="home__description"> B. Tech CSE student with a passion for creative problem-solving and continuous learning. Seeking an opportunity to utilize my skills and gain experience.
</p>
